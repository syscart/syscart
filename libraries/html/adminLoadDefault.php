...
class htmlAdminLoadDefault
{
    ...
    {
        global $sysDoc, $sysConfig, $sysDocStyle;
    ...
    public function scriptFooter()
    {
        ...
        $sysDocScript->setFooter($sysConfig->get('url').'templates/backend/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js');
        $sysDocScript->setFooter($sysConfig->get('url').'templates/backend/js/plugins.js');
        $sysDocScript->setFooter($sysConfig->get('url').'templates/backend/js/actions.js');
    }
}
?>