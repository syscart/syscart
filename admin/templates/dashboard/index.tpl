        ...
        <ul class="x-navigation">
            ...
            <li class="xn-openable active">
                ...
                <ul>
                    ...
                    <li class="active"><a href="layout-nav-right.html">Navigation Right</a></li>
            ...
            <li class="xn-openable">
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li><a href="form-layouts-one-column.html"><span class="fa fa-align-justify"></span> One
                                    Column</a></li>
                            <li><a href="form-layouts-two-column.html"><span class="fa fa-th-large"></span> Two
                                    Column</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            Add class <code>.page-mode-rtl</code> to <code>.page-container</code> to set right direction
                            for navigation.
                        </div>
                    </div>
                </div>
